...
mixin _$RoutineState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Routine> routines) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Routine> routines)? loaded,
...
abstract class _Initial implements RoutineState {
...
abstract class _Loading implements RoutineState {
...
class __$$LoadedImplCopyWithImpl<$Res>
    extends _$RoutineStateCopyWithImpl<$Res, _$LoadedImpl>
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Routine> routines) : _routines = routines;
  ...
  @override
  String toString() {
    return 'RoutineState.loaded(routines: $routines)';
  }
...
abstract class _Loaded implements RoutineState {
  const factory _Loaded(final List<Routine> routines) = _$LoadedImpl;
...
abstract class _Error implements RoutineState {
